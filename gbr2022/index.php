...
<html xmlns="http://www.w3.org/1999/xhtml" 
   ...
   xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" >
     ...
     <head>
        ...
        <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/css/index.dc64fdcb.css" type="text/css" />

        <style>@page { size: legal portrait; }</style>
    ...
    <header>
        ...
        <div class="bg-danger">
          ...
          <nav class="navbar navbar-dark navbar-expand-lg">
                ...
                <div class="container"> <a class="d-md-none d-print-none navbar-brand"
                        ...
                        class="bg-white d-md-block d-none d-print-block navbar-brand p-3"
                        ...
                        style="margin-top:-15px;margin-bottom:-35px;z-index:100;" href="<?php echo JURI::root(); ?>"><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/logo.625825ed.svg"
                            ...
                            alt="Gallardo Bienes Raíces" width="160"></a> <button class="d-print-none navbar-toggler" type="button"
    ...
    <div class="d-print-none bg-primary sticky-lg-top">

            <jdoc:include type="modules" name="searchbar" />

    </div>

    <section class="d-print-none" id="breadcrumbs">
