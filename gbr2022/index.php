    ...
    <header>
        <div class="bg-danger">
            <nav class="bg-white d-block d-lg-none navbar navbar-light">
                <div class="container-fluid"> <a class="navbar-brand" href="#"><img class="mx-auto" src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/logo.aaaf9e15.png" alt="Gallardo Bienes Raices"></a>
            ...
            <nav class="bg-black bg-opacity-25 d-lg-block d-none navbar navbar-dark navbar-expand" id="barNavLg">
                <div class="container"> <a class="logo navbar-brand" href="#"><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/logo.aaaf9e15.png" alt="Gallardo Bienes Raices"></a>
