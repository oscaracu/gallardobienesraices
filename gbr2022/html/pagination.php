...
function pagination_list_render($list)
{
	...
	$html .= '<ul class="pagination justify-content-center flex-wrap my-4">';
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text === JText::_('JLIB_HTML_START'))
	{
		return '<li class="disabled page-item"><a class="page-link">' . $item->text . '</a></li>';
	}
	...
	if (isset($item->active) && $item->active)
	{
		...
		return '<li class="active page-item"><a class="page-link" aria-current="true" aria-label="' . $aria . '">' . $item->text . '</a></li>';
	}
